...
class FullSphericalHarmonicsViSNetDynamics(nn.Module):
    """
    ViSNet Dynamics với việc sử dụng ĐẦY ĐỦ spherical harmonics
    
    Key Insight: 
    - l=0: Scalar features (energies, charges)
    - l=1: Vector features (velocities, forces)  
    - l=2: Quadrupole features (angular patterns, strain)
    """
